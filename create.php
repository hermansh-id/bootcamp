...
if (isset($_POST['createRecord'])) {
  $title = filter_var($_POST['tittle'], FILTER_SANITIZE_STRING);
  $author = filter_var($_POST['autor'], FILTER_SANITIZE_STRING);
  ...
  <div class="container">
    ...
    <form method="post" action="create.php">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" id="title" name="tittle" value="">
        </div>
      </div>
      <div class="form-group row">
